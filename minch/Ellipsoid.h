...
public:
	Ellipsoid(const Vector& position, const Vector& coefficients, const Vector& material_scalars, const Vector& diffuse_color, const Vector& specular_color, int specularity);
	~Ellipsoid();
